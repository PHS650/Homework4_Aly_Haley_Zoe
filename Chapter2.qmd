...
@tbl-newvars describes 5 new variables, norm.loudness, norm.tempo, itensity, duration_mins, popularity created from the Spotify dataset. Also describes 2 existing variables, loudness and tempo. The table provides the class, range, and description of each new variable.
