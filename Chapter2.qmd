...
@tbl-newvars describes 7 variables; 2 prior variables loudness and tempo used to create new variables, and 5 new variables: norm.loudness, norm.tempo, intensity, duration_mins, popularity created from the Spotify dataset. The table provides the class, range, and description of each new variable.
